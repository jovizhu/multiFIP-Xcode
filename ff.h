 ...
 */
extern double gtempl_time, greach_time, grelev_time, gconn_time;
extern double gsearch_time;
...
/* used for multible goals pddl parsing
 * the problem name
 * the domain name
 */
extern char *gmul_problem_name;
extern char *gmul_domain_name;
...
/* not yet preprocessed additional goal facts
 */
extern PlNode *gadd_orig_goal_facts;
